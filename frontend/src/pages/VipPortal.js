      ...
      <div style={{ ...s.body, paddingTop: "12px" }}>
        ...
        <div style={s.row2}>
          ...
          <div style={s.card}>
            ...
            {orders.length === 0 ? (
              <p style={s.emptyText}>No VIP orders placed yet</p>
            ) : (
              <table style={s.table}>
                <thead>
                  <tr>
                ...
                <tbody>
                  {orders.map((o, i) => (
                    <tr key={i}>
                      ...
                      <td style={s.td}>
                        <span style={s.badgeYellow}>
                          {o.status}
                        </span>
                      </td>
                      <td style={{ ...s.td, color: "var(--text-muted)", fontSize: "12px" }}>{o.wait}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
...
const s = {
  ...
  starIcon:    { fontSize: "32px", backgroundColor: "var(--bg-app)", border: "1px solid var(--border-ui)", borderRadius: "10px", padding: "8px", display: "inline-flex", alignItems: "center", justifyContent: "center" },
  heading:     { margin: 0, fontSize: "24px", fontWeight: "700", color: "var(--text-main)" },
  subheading:  { margin: "4px 0 0", color: "var(--text-muted)", fontSize: "13px", maxWidth: "700px" },
  banner:      { backgroundColor: "var(--bg-app)", border: "2px dashed var(--border-ui)", borderRadius: "10px", padding: "14px 18px", fontSize: "13px", color: "var(--text-main)", marginBottom: "24px" },
